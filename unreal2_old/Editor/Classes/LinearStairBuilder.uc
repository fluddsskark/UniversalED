...
var() int StepLength, StepHeight, StepWidth, NumSteps;
var() name GroupName;

event bool Build()
{
	local int i, LastIdx, CurrentX, CurrentY, CurrentZ;
	...
	// Back poly.
	Vertex3f( StepLength * NumSteps,	StepWidth,	-StepHeight );
	Vertex3f( StepLength * NumSteps,	StepWidth,	StepHeight * (NumSteps - 1));
	Vertex3f( StepLength * NumSteps,	0,			StepHeight * (NumSteps - 1) );
	Vertex3f( StepLength * NumSteps,	0,			-StepHeight );
	...
	for( i = 0 ; i < Numsteps ; i++ )
	{
		...
		// Top of the step
		Vertex3f( CurrentX,		CurrentY,				CurrentZ );
		Vertex3f( CurrentX,		CurrentY,				CurrentZ - StepHeight );
		Vertex3f( CurrentX,		CurrentY + StepWidth,	CurrentZ - StepHeight );
		Vertex3f( CurrentX,		CurrentY + StepWidth,	CurrentZ );
		...
		Vertex3f( CurrentX,								CurrentY,		CurrentZ );
		Vertex3f( CurrentX,								CurrentY,		CurrentZ - StepHeight );
		Vertex3f( CurrentX + (StepLength*(Numsteps-i)),	CurrentY,		CurrentZ - StepHeight );
		...
		Vertex3f( CurrentX,								CurrentY + StepWidth,		CurrentZ );
		Vertex3f( CurrentX,								CurrentY + StepWidth,		CurrentZ - StepHeight );
		Vertex3f( CurrentX + (StepLength*(Numsteps-i)),	CurrentY + StepWidth,		CurrentZ - StepHeight );
