...
public:
	...
	BITFIELD	ShowVertices:1;		// Causes vertices to be displayed extra large so they can be selected/moved easier
...
class EDITOR_API UEditorEngine : public UEngine, public FNotifyHook
{
	...
	virtual void polySetAndClearPolyFlags2( UModel* Model, DWORD SetBits, DWORD ClearBits, INT SelectedOnly, INT UpdateMaster );
#endif
	...
	virtual void edactDuplicateSelected( ULevel* Level, UBOOL DuplicateUpstreamConnections=0 );
#else
...
#endif
#if 1 //NEW: ParticleSystems
	virtual void edactExportParticleSystems( ULevel* Level, FName PackageName );
...
#if 1 //NEW: Lighting
	virtual void shadowIlluminateBsp( ULevel* Level, UBOOL Selected, INT xRes=128, INT yRes=128, UBOOL ShowMaps=0 );
#else
