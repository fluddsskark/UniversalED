...
class EDITOR_API UWaveMeshBuilder : public UBrushBuilder
{
public:
    FLOAT Width;
    FLOAT Height;
    ...
    INT VTexTile;
    FLOAT Noise;
    BITFIELD bFixedEdges:1 GCC_PACK(4);
    BITFIELD bFlushEdges:1;
    BITFIELD bShiny:1;
    BITFIELD bMultiTexture:1;
    BYTE MeshType GCC_PACK(4);
    DECLARE_FUNCTION(execCreateWavyMesh);
    DECLARE_CLASS(UWaveMeshBuilder,UBrushBuilder,0,Editor)
    NO_DEFAULT_CONSTRUCTOR(UWaveMeshBuilder)
};

#endif

AUTOGENERATE_FUNCTION(UWaveMeshBuilder,-1,execCreateWavyMesh);
