...
class WDlgSearchActors : public WDialog
{
	...
	,	GotoActorButton	( this, IDPB_GOTOACTOR,		FDelegate(this,(TDelegate)OnActorListDblClick) )
	,	DeleteActorButton( this, IDPB_DELETEACTOR,	FDelegate(this,(TDelegate)OnDeleteActor) )
