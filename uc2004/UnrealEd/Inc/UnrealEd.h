...
#include "ParticleEditorControls.h"
#include "ParticleEditor.h"
#include "ParticleEditorTab.h"
#include "ParticleEditorToolLabel.h"
...
#ifdef WITH_LIPSINC
	extern WBrowserLIPSinc* GBrowserLIPSinc;
#endif
...
class UNREALED_API UUnrealEdEngine : public UEditorEngine, public FNotifyHook
{
	...
	// UEngine Interface.
	void Draw( UViewport* Viewport, FLOAT DeltaSeconds, UBOOL Blit=1, BYTE* HitData=NULL, INT* HitSize=NULL );
	...
	//scion superville
	void Bump(UViewport* Viewport, INT ph, INT pv);	// when movement key is pressed
};
