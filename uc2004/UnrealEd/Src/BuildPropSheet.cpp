...
void WPageOptions::OnBuildClick()
{
	...
	UBOOL bError = 0;
	//scion jg -- Add warnings for deprecated classes
	for (TObjectIterator<AActor> It ; It ; ++It)
	{
		// Add a warning if this class is obsolete
		if (It->GetClass()->ClassFlags & CLASS_Deprecated)
		{
			GWarn->MapCheck_Add(MCTYPE_WARNING, *It,
				TEXT("This class has been deprecated and should not be used"));
			bError = 1;
		}
	}
	if (bError != 0)
