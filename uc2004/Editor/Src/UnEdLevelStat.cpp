...
//------------------------------------------------------------------------------
UBOOL FEdLevelStat::Analyze( ULevel* InLevel )
{
	Init();
...
//------------------------------------------------------------------------------
UBOOL FEdLevelStat::IsTextureUnique( UTexture* tex )
{
...
//------------------------------------------------------------------------------
void FEdLevelStat::AddMaterialTextures( UMaterial* mat )
{
	...
	else if( Cast<UShader>( mat ) )
	{
		...
		AddMaterialTextures( shader->Bump );
...
//------------------------------------------------------------------------------
void FEdLevelStat::AddStaticMeshGeom( UStaticMesh* mesh )
{
...
//------------------------------------------------------------------------------
void FEdLevelStat::AddMeshGeom( ULodMesh* mesh )
{
...
//------------------------------------------------------------------------------
void FEdLevelStat::AddBspGeom( UModel* model )
{
	/*
	{
...
//------------------------------------------------------------------------------
void FEdLevelStat::AddTerrainGeom( ATerrainInfo* terrainInfo )
{	
	// -- byte counts
	{
...
//------------------------------------------------------------------------------
void FEdLevelStat::PrintTextureSummary( FOutputDevice& Ar )
{
	Ar.Logf( TEXT("") );
...
//------------------------------------------------------------------------------
void FEdLevelStat::PrintTextureDetails( FOutputDevice& Ar )
{
	Ar.Log( TEXT("") );
...
//------------------------------------------------------------------------------
void FEdLevelStat::PrintGeomSummary( FOutputDevice& Ar )
{
	Ar.Logf( TEXT("") );
...
//------------------------------------------------------------------------------
FString FEdLevelStat::GetFormatDesc( ETextureFormat format )
{
	switch( format )
	{
	...
	case TEXF_V8U8:		return TEXT("V8U8");
	case TEXF_L6V5U5:	return TEXT("L6V5U5");
	case TEXF_V16U16:	return TEXT("V16U16");
	case TEXF_A8:		return TEXT("A8");
		break;
	}
