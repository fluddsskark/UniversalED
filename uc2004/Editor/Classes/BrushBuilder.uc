...
// Native support.
native final function BeginBrush( bool MergeCoplanars, name Group );
native final function bool EndBrush();
native final function int GetVertexCount();
native final function vector GetVertex( int i );
native final function int GetPolyCount();
native final function bool BadParameters( optional string msg );
native final function int Vertexv( vector v );
native final function int Vertex3f( float x, float y, float z );
native final function Poly3i( int Direction, int i, int j, int k, optional name ItemName, optional int PolyFlags );
native final function Poly4i( int Direction, int i, int j, int k, int l, optional name ItemName, optional int PolyFlags );
native final function PolyBegin( int Direction, optional name ItemName, optional int PolyFlags );
native final function Polyi( int i );
native final function PolyEnd();
